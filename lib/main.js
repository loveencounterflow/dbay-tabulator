(function() {
  'use strict';
  var CND, Common_mixin, GUY, HDML, SQL, badge, debug, echo, help, hide_sym, info, ref, rpr, urge, warn, whisper,
  ...
  ref = this.Tabulator = class Tabulator extends Common_mixin() {
    ...
    tabulate(cfg) {
      var R, d, field, fields, has_ths, i, key, keys, len, push_table_headers, ref1, row, row_nr, rows, td, title;
