(function() {
  ...
  this.Tabulator = class Tabulator extends Common_mixin() {
    //---------------------------------------------------------------------------------------------------------
    as_html(cfg) {
      var R, d, field, fields, has_ths, i, key, keys, len, push_table_headers, ref, row, row_nr, rows, title;
...
//.......................................................................................................
    ...
    _set_value(cfg, row, field, key, d) {
      ...
      d.value = d.raw_value;
      if (d.value === void 0) {
        d.value = (ref = field != null ? field.undefined : void 0) != null ? ref : cfg.undefined;
      }
      return d;
    }
    ...
    _td_from_details(d) {
      var ref, ref1;
      if (((ref = d.field) != null ? ref.outer_html : void 0) != null) {
        return d.field.outer_html(d.value, d);
      } else if (((ref1 = d.field) != null ? ref1.inner_html : void 0) != null) {
        return HDML.pair('td', {
          class: d.key
        }, d.field.inner_html(d.value, d));
      }
