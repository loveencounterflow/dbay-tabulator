(function() {
  ...
  this.Tabulator = class Tabulator extends Common_mixin() {
    ...
    _raw_value_and_value_from_cfg_row_field_and_key(cfg, row, field, key) {
      var raw_value, ref, ref1, value;
      raw_value = row[key];
      value = raw_value;
      if (value === void 0) {
        value = (ref = (ref1 = field != null ? field.undefined : void 0) != null ? ref1 : cfg.undefined) != null ? ref : 'undefined';
      }
    ...
    //---------------------------------------------------------------------------------------------------------
    _table_as_html(cfg) {
      var R, as_html, details, field, fields, has_ths, i, inner_html, is_done, key, keys, len, push_table_headers, raw_value, ref, ref1, ref2, row, row_nr, rows, title, value;
      ({rows} = cfg);
...
//.......................................................................................................
      for (row of rows) {
        ...
        for (i = 0, len = keys.length; i < len; i++) {
          ...
          //...................................................................................................
          ({raw_value, value} = this._raw_value_and_value_from_cfg_row_field_and_key(cfg, row, field, key));
          is_done = false;
          inner_html = null;
          if (field != null) {
            ...
            if ((as_html = (ref1 = field.outer_html) != null ? ref1 : null) != null) {
              is_done = true;
              R.push(as_html(value, details));
            } else if ((as_html = (ref2 = field.inner_html) != null ? ref2 : null) != null) {
    ...
    row_as_subtable_html(cfg) {
      var R, field, fields, i, key, keys, len, raw_value, row, title, value;
